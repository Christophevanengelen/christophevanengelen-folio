...
(function () {
  ...
  if (hasST) {
    ...
    document.querySelectorAll('.home-cases__h2, .home-practice__h2, .home-formats__h2, .home-track__h2, .home-about__h2, .home-faq__h2, .home-contact__h2, .home-awards__h2').forEach((h) => {
      gsap.fromTo(h,
